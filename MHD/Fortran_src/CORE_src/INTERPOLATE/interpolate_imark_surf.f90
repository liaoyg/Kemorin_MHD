!>@file   interpolate_imark_surf.f90
!!@brief  module interpolate_imark_surf
!!
!!@author H. Matsui
!!@date Programmed in Sep., 2006
!
!>@brief  interpolation on surface
!!
!!@verbatim
!!      subroutine s_interpolate_imark_surf4(np_smp, numnod, numele,    &
!!     &          ie, imark_org, istack_smp, num_points, iele_gauss,    &
!!     &          isurf_gauss, imark)
!!      subroutine s_interpolate_imark_surf8(np_smp, numnod, numele,    &
!!     &          ie, imark_org, istack_smp, num_points, iele_gauss,    &
!!     &          isurf_gauss, imark)
!!      subroutine s_interpolate_imark_surf9(np_smp, numnod, numele,    &
!!     &          ie, imark_org, istack_smp, num_points, iele_gauss,    &
!!     &          isurf_gauss, imark)
!!
!!      subroutine s_interpolate_i8mark_surf4(np_smp, numnod, numele,   &
!!     &          ie, i8mark_org, istack_smp, num_points, iele_gauss,   &
!!     &          isurf_gauss, i8mark)
!!      subroutine s_interpolate_i8mark_surf8(np_smp, numnod, numele,   &
!!     &          ie, i8mark_org, istack_smp, num_points, iele_gauss,   &
!!     &          isurf_gauss, i8mark)
!!      subroutine s_interpolate_i8mark_surf9(np_smp, numnod, numele,   &
!!     &          ie, i8mark_org, istack_smp, num_points, iele_gauss,   &
!!     &          isurf_gauss, i8mark)
!!@endverbatim
!
...
!$omp end parallel do
!
      end subroutine s_interpolate_i8mark_surf4
!
! ----------------------------------------------------------------------
!
      subroutine s_interpolate_i8mark_surf8(np_smp, numnod, numele,     &
...
!$omp end parallel do
!
      end subroutine s_interpolate_i8mark_surf8
!
! ----------------------------------------------------------------------
!
      subroutine s_interpolate_i8mark_surf9(np_smp, numnod, numele,     &
...
!
          ...
          i9 = ie(iele,k9)
!
          i8mark(ig) = i8mark_org(i9 )
        end do
      end do
!$omp end parallel do
!
      end subroutine s_interpolate_i8mark_surf9
!
! ----------------------------------------------------------------------
!
