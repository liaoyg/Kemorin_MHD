...
!  ---------------------------------------------------------------------
!
      subroutine noise_sampling(noise_size, noise_data, xx_org,     &
      &       xyz_min, xyz_max, noise_freq, noise_value)

      use set_parallel_file_name
      !
      integer(kind = kint), intent(in) :: noise_size
      character(len=1), intent(in) :: noise_data(noise_size)
      real(kind = kreal), intent(in) :: xx_org(3), xyz_min(3), xyz_max(3), noise_freq
...
!  ---------------------------------------------------------------------
!
      subroutine noise_grad_sampling(noise_size, noise_grad, xx_org,      &
      &       xyz_min, xyz_max, noise_freq, grad_value)
...
!  ---------------------------------------------------------------------
!
      subroutine noise_nd_sampling(noise_size, n_node, xx_org,    &
      &       xyz_min, xyz_max, noise_freq, noise_value)
