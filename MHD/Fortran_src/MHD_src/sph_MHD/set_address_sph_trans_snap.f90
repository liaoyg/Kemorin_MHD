...
!-----------------------------------------------------------------------
!
      subroutine set_addresses_snapshot_trans(iphys, ipol, trns_snap,   &
     &          ncomp_sph_trans, nvector_sph_trans, nscalar_sph_trans)
!
...
!
     ...
     &   (ipol, iphys, trns_snap%nvector_rj_2_rtp, trns_snap%b_trns)
      call b_trans_address_scalar_snap                                  &
     &   (ipol, iphys, trns_snap%nvector_rj_2_rtp,                      &
     &    trns_snap%nscalar_rj_2_rtp, trns_snap%b_trns)
      trns_snap%ntensor_rj_2_rtp = 0
!
      call f_trans_address_vector_snap                                  &
     &   (iphys, ipol, trns_snap%nvector_rtp_2_rj, trns_snap%f_trns)
      call f_trans_address_scalar_snap                                  &
     &   (iphys, ipol, trns_snap%nvector_rtp_2_rj,                      &
...
!
     ...
     &         (iphys, ipol, nvector_snap_rtp_2_rj, fs_trns)
!
      type(phys_address), intent(in) :: ipol, iphys
...
!-----------------------------------------------------------------------
!
      subroutine f_trans_address_scalar_snap(iphys, ipol,               &
